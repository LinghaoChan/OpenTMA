...
# python -m train --cfg configs/configs_temos/config_temos_wounimocap_1e-5_infonce_multi_gpu_nce1e-1_layer6_head6-newmetrics_neg256-recliploss_pretrain.yaml --cfg_assets configs/assets.yaml --nodebug